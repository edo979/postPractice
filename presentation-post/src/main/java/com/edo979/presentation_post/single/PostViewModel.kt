...
class PostViewModel @Inject constructor(
    private val useCase: GetSinglePostWithUserUseCase, private val converter: PostConverter
    ...
    private fun loadPost(postId: Long) {
        viewModelScope.launch {
            useCase.execute(GetSinglePostWithUserUseCase.Request(postId = postId)).map {
